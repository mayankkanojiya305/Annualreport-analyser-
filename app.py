...
if uploaded_file is not None:
    with st.spinner("AI Report padh raha hai... Isme 10-15 seconds lag sakte hain ⏳"):
        try:
            # 1. PDF se Text nikalna (Shuru ke kuch pages taaki fast ho)
            ...
            # 3. AI ke Data ko saaf karna aur graph banana
            ...
            # Screen ko 2 hisso mein batna (Table & Chart)
            ...
            st.error(f"Data extract karne mein problem aayi. Dusra PDF try karein. Error: {e}")
